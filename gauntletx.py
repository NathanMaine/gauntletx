...
run expectations, and pick it by harness family. For Claude Code, Codex, Gemini CLI, opencode, Antigravity, and
...
IS an agentic harness (Claude Code, Codex, Gemini CLI, opencode, Antigravity, a local model), NOTES skip it.
Other bullets as useful: how to run it — paste into the target harness, and the
"/effort ultracode" tip only in a Claude Code prompt's NOTES (Codex, Gemini CLI, opencode, Antigravity, local,
...
- HARNESS: exactly one of: Claude Code, Codex, Gemini CLI, opencode, Antigravity, Qwen3 Coder Next (local),
  ...
  "open code" → opencode; "antigravity", "anti gravity", or "antigravity cli" →
...
async function runDraft(){
  ...
  try{
    ...
    const HS=['Claude Code','Codex','Gemini CLI','opencode','Antigravity','Qwen3 Coder Next (local)',
      'Qwen 3.8 (local)','DeepSeek V4 Flash (local)','Qwen 3.8 Max (API)','Claude (web)',
